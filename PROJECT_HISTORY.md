...
> **서버 현재 버전: `TBD`** ← 최신 (GitHub) — BUG-059 + FEAT-037 공유텍스트 형식 변경
...
|------|------|------|------|----------|------|
| BUG-059 | 81 | 2026-07-03 | ✅ 수정 | `/tbm-share/:token` 500 에러 — tasks.manager_name 없음(supervisor JOIN으로 수정) + FEAT-037 공유 텍스트 형식 변경 | `TBD` |
