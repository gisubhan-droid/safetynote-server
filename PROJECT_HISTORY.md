...
> 최종 업데이트: 2026-07-04 (세션 88)
> **서버 현재 버전: `TBD`** ← 최신 (GitHub) — BUG-065 접속단가 테이블 열순서/헤더 변경
...
|------|------|------|------|----------|------|
| BUG-065 | 88 | 2026-07-04 | ✅ 수정 | 접속단가 테이블 열 순서/헤더 변경 — 순서: 공종키\|공종명\|단위\|기본\|야간\|신호수 / 공종키 읽기전용 열 추가 / 헤더 단축: 기본(원)·야간(원)·신호수(원) | `TBD` |
