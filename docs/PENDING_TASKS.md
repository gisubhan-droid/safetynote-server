...
| Phase 4 | NAS 설치 · 운영 매뉴얼 PDF | ⏳ 대기 | 다음 목표 |
| Phase 6 — 타 NAS 원클릭 설치 패키지 (install.sh 완성) | ✅ 완료 (세션 55) | — |
...
| Phase 6 — install.sh v2.0 완성 (신규·업데이트·재설치 3모드) | 세션 55 | (이번 커밋) |
| .env.example NAS용 전면 보완 (FCM 항목 추가) | 세션 55 | (이번 커밋) |
