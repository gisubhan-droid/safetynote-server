...
> 최종 업데이트: 2026-06-17 (세션 27)
> **서버 현재 버전: 400fb93** ← 최신 (FEAT-024 v4 + 롤백 태그 정리)
> NAS 배포 버전: 0b80f69 (git pull 필요 — 세션26~27 변경사항 미반영)
> **캐시 버전: v=20260617j**
...
| 항목 | 상태 | 내용 |
|------|------|------|
| FEAT-024 모바일 스크롤 팝업 닫힘 | 🔄 **NAS 반영 후 실기기 확인 필요** | v4 수정 완료(e531fc2) — modal-sm 단순 조건으로 완전 차단 |
| BUG-002 사진 탭 그룹 표시 | ✅ 코드 수정 완료 | TYPE_LABEL/ORDER/COLOR + PHOTO_TYPE_DIRS 3개 유형 추가(b245c84) |
| BUG-006 APK 다운로드 실패 | ✅ 완료 | typeof Log 체크 + a download 방식 + 버전 파일명(d51f355) |
