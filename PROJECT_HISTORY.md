...
> **서버 현재 버전: a473c4a** ← 최신
> **NAS 배포 버전: a473c4a** ✅ 반영 완료 (세션27 변경사항 적용 확인)
> **캐시 버전: v=20260617j**
...
| 해시 | 설명 |
|------|------|
| (이번 세션) | fix: BUG-008 서버 설정 화면 전면 개선 + 접속 테스트 버튼 + 포트 기본값 3443 |
...
| 버전 | 날짜 | 빌드 상태 | 주요 변경 내용 |
|------|------|-----------|----------------|
| **v1.4.4** | **2026-06-18** | 🔲 빌드 예정 | 서버 설정 화면 개선(수정 가능/접속 테스트/포트 기본값 3443), BUG-008 수정 |

### 세션 29 미완료 → 다음 세션
- [ ] **APK v1.4.4 빌드** — GitHub Actions 트리거 필요
