...
> 최종 업데이트: 2026-07-04 (세션 86)
> **서버 현재 버전: `TBD`** ← 커밋 후 확정 예정 — BUG-063 단가 엑셀 업로드 404 수정
...
|------|------|------|------|----------|------|
| BUG-063 | 86 | 2026-07-04 | ✅ 수정 | 단가 엑셀 업로드 404 에러 — `API.post`에 `/api/` 접두어 사용(이중 baseURL) → `/volume-unit-prices/import`, `/splice-unit-prices/import`로 수정 | `TBD` |
