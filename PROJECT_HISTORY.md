...
> 최종 업데이트: 2026-07-03 (세션 84)
> **서버 현재 버전: `TBD`** ← 커밋 후 확정 예정 — BUG-059 공유 텍스트 담당자/공사감독자 추가
...
|------|------|------|------|----------|------|
| BUG-059 | 81→84 | 2026-07-03 | ✅ 수정 | `/tbm-share/:token` 500 에러 — tasks.manager_name 없음(supervisor JOIN으로 수정) + FEAT-037 공유 텍스트 형식 변경 ✅ **세션84: 공유 텍스트 담당자(contractor_name)·공사감독자(lgu_supervisor) 추가** | `ac4381e`→`TBD` |
