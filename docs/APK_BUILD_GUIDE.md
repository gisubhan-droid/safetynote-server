...
- 현재 최신 APK 버전: **v1.4.18** (세션 146 기준)
- 다음 빌드 시 **버전을 +0.0.1 올린다**: `1.4.18` → `1.4.19`
...
| v1.4.18 | 세션146 | `13f2a60` | **FEAT-218 BUG-FIX: FCM 알림 탭 무반응 근본 수정 — data-only 메시지 전환(fcm.ts) + pendingFcmIntent 패턴(onResume public)** |
