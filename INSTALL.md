...
### ℹ️ 업데이트 중 UI 안내 메시지 (정상 동작)

> **[BUG-208 해결 — 2026-08-03 세션 133]**  
> GitHub push → Webhook → pm2 restart 진행 중 업데이트 UI에 표시되는 메시지:
>
> | 메시지 | 의미 |
> |--------|------|
> 🟡 **"서버 재시작 중... 잠시 대기하세요 ⏳"** | pm2 restart 중 정상 대기 상태 |
> ✅ **"Webhook 자동 업데이트 완료!"** | 업데이트 성공 |
>
> 재시작 중 서버가 수 초간 다운되므로 폴링이 잠시 실패합니다. **완전히 정상입니다.**  
> 수 초 후 자동으로 완료 상태로 전환됩니다. (app.js v=20260803g+ 적용 시)
